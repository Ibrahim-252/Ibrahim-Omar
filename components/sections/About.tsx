...
function useVisible() {
  ...
  useEffect(() => {
    const observer = new IntersectionObserver(
      ([entry]) => entry.isIntersecting && setV(true),
      { threshold: 0.1 }
    );
...
export default function About() {
  ...
  const infoCards = [
    ...
    {
      label: "Stack",
      value: "Next.js · TypeScript · Supabase · MongoDB · AI Systems",
    },
        ...
        >
          ...
          <div>
            ...
            >
              {h1}
              <br />
              <span style={{ color: "var(--accent-blue)" }}>{h2}</span>
            </h2>
            ...
            >
              ...
              <a
                href="https://dev.ibrahimomar.com"
                target="_blank"
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            <div
              style={{
                ...
                boxShadow: "0 12px 40px rgba(20,18,16,0.09)",
              }}
            >
              <Image
                src="/ibrahim.png"
            ...
            {infoCards.map((card) => (
              ...
              >
                ...
                <span
                  style={{
                    fontSize: "12px",
                    color: card.green ? "var(--green)" : "var(--text)",
                    fontWeight: 500,
                    textAlign: "right",
                  }}
                >
